                ...
                <tbody>
                  {
                     users.map((user,index)=>{
                        ...
                        <td>{user.salary}</td>
                        <th>
                       <Link to={`/User-edit/${user.id}`}>   <button className="btn btn-primary btn-sm" >Etid</button></Link>
                          
                         <button onClick={()=>onDelete(user.id)} className="btn btn-danger btn-sm ml-2">Delete</button>
